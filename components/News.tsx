        ...
        <section id="news" className="relative">
            ...
            <div className="mx-auto bg-[#8EACE2] text-white w-[125px] text-center mb-[60px] py-2 rounded-[16px] border-2 border-black">
                <p className="text-[12px] relative mr-3">
                    VIEW MORE
                    <span
                        className={`emoji ${ended ? "throw-icon-out" : ""} overflow-hidden absolute top-[-1px] right-1 text-[14px]`}
                    >
                        😎
                    </span>
                    <span
                        className={`emoji throw-icon-in absolute top-[-1px] right-1 text-[14px]`}
            ...
            <span
                className={`emoji helicopter absolute left-[10px] scale-x-[-1] scale-y-[1]
                text-[30px]`}
            >
                🚁
            </span>
            <div className="absolute top-[80px] right-[10px]">
                <span
                    className={`emoji absolute top-[50%] left-[50%] translate-[-50%] scale-x-[-1]
