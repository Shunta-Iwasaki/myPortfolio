...
function ContentHeader({ title, emoji, side }: contentHeaderProps) {
    return (
        <div className="sticky top-[2px] z-10">
            <div
                className="bg-[#3B63AB] relative border-b-2 mb-9 h-[70px] pt-4.5 rounded-t-[12px] shadow-top z-20
        ...
        after:content-[] after:absolute after:right-2 after:top-1.5 after:block after:w-[10px] after:h-[10px] after:rounded-[50%] after:bg-white after:border-2"
            >
                <div
                    className={`bg-[#3B63AB] border-2 border-t-0 w-[24%] h-[20px] block absolute ${side} bottom-[calc(-20px)]`}
                ></div>
