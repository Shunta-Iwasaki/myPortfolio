...
const Footer = () => {
    ...
    return (
        <footer className="bg-[#3B63AB] h-[130px] border-t-2 relative rounded-b-[12px]">
            {/* 上丸 */}
            <div
                className="before:content-[] before:absolute before:left-2 before:top-1.5 before:block before:w-[10px] before:h-[10px] before:rounded-[50%] before:bg-white before:border-2
            ...
            <div className="text-white text-center">
                <div className="flex justify-center mt-4 gap-1">
                    ...
                    <FooterCard emoji="😊" text="ABOUT ME" href="#about" />
                    <FooterCard emoji="💻" text="SKILLS" href="#skills" />
                </div>
                ...
                <p className="text-[10px] mt-6">{year} SHUNTA IWASAKI</p>
            </div>
            {/* 下丸 */}
            <div
                className="before:content-[] before:absolute before:left-2 before:bottom-1.5 before:block before:w-[10px] before:h-[10px] before:rounded-[50%] before:bg-white before:border-2
            after:content-[] after:absolute after:right-2 after:bottom-1.5 after:block after:w-[10px] after:h-[10px] after:rounded-[50%] after:bg-white after:border-2"
            ></div>
        </footer>
    );
};
